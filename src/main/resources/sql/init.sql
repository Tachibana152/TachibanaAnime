...
-- 其余动漫补全制作阵容/别名/语录/简介/内容（源自 web课设素材 各详情页，原文保留）
UPDATE anime
SET music         = 'Evan Call',
    chara_design  = '高瀬丸(高瀬亜貴子)、小嶋慶祐、藤中友里',
    series_composition = '鈴木智尋',
    art_director  = '高木佐和子',
    color_design  = '大野春恵',
    photography_director = '伏原あかね',
    quote         = '葬送のフリーレン',
...
UPDATE anime
SET synopsis      = '动画短片集《中国奇谭2》由9部风格迥异的短片组成：《耳中人》《小雪》《拜山》《如何成为三条龙》《大鸟》《三郎》《今日动物园》《刑天》《大贵人》。12位导演在延续中式想象力的基础上，探索多元题材与风格，挖掘中式内核表达，同时增强了现实关照和寓言属性，在奇幻语境中探寻现实命题，对人的自我身份、家庭关系、社会关系等进行思考和探讨。',
...
SET music         = '末廣健一郎',
    chara_design  = '守岡英行',
    series_composition = '亜田井',
    art_director  = '堀越由美',
    color_design  = '佐藤直子',
    chief_animation_director = '久保茉莉子、徳田夢之介、吉岡佳広',
    photography_director = '武井夏樹',
    alias         = '炎炎消防队 第三季 第2部分',
    quote         = '全人类为之恐惧——',
...
UPDATE anime
SET storyboard    = '坂詰嵩仁、榎戸駿',
    performance   = '榎戸駿、坂詰嵩仁',
    music         = '澤野弘之',
    chara_original = '森井しづき',
    chara_design  = '山田有慶；副人设：滝山真哲、相音光、浜友里恵、おかざきおか',
    series_composition = '大東大介',
    art_director  = '清木亜夕',
    color_design  = '茂木孝浩',
    chief_animation_director = '山田有慶',
    animation_director = '曽根拓人、伊藤公規、相音光、おかざきおか、近藤明也圭、普津澤時ヱ門、浜友里恵、茂木眞一',
    photography_director = '宮脇洋平',
    planning      = '岩上敦宏、竹内友崇(武内崇)、佐藤真紀、羽川寛、大塚則和',
    alias         = '命运-奇异赝品、FSF',
    quote         = '聚集于此的，乃是人类史上最大的英雄谭。',
...
UPDATE anime
SET storyboard    = '御所園翔太',
    performance   = '御所園翔太、高田陽介',
    music         = '照井順政',
    chara_design  = '矢島陽介・丹羽弘美',
    series_composition = '瀬古浩司',
    art_director  = '東潤一',
    color_design  = '松島英子',
    chief_animation_director = '矢島陽介、丹羽弘美、森光恵、山崎爽太、清水貴子',
    animation_director = '堀江由美、荏原裕子、三谷高史、野田友美、高田陽介、長友望己、奥田哲平',
    photography_director = '伊藤哲平',
    alias         = 'Jujutsu Kaisen: Shimetsu Kaiyuu、呪術廻戦 死滅回游 前編',
...
UPDATE anime
SET music         = '浜口史郎',
    chara_original = '島田フミカネ、杉本功；协力：野上武志',
    chara_design  = '杉本功',
    series_composition = '木村暢',
...
UPDATE anime
SET music         = '澤野弘之',
    chara_original = '美樹本晴彦',
    chara_design  = 'Pablo Uchida、恩田尚之、工原しげき',
    art_director  = '大久保錦一',
    color_design  = 'すずきたかこ、久保木裕一',
    photography_director = '大山佳久',
    planning      = 'サンライズ',
    alias         = 'MOBILE SUIT GUNDAM HATHAWAY The Sorcery of Nymph Circe',
...
SET music         = '伊賀拓郎',
    chara_design  = '平山寛菜',
    series_composition = '田中仁',
    art_director  = '宇佐美哲也',
    color_design  = '芦原明音',
    chief_animation_director = '朱里、稲手遥香、錦寛乃、森田莉奈、平山寛菜、室賀彩花、水野公彰',
    photography_director = '桒野貴文',
    alias         = '"Oshi no Ko" 3、Oshi no Ko 3rd Season',
    quote         = 'この芸能界（せかい）において嘘は武器だ。在演艺圈（这个世界）中，谎言就是武器。',
...
UPDATE anime
SET storyboard    = '大沼心(1,7,12)、帆村壮二 [ 新房昭之 ](2)、上坪亮樹(3)、森義博(4)、草川啓造(5,8,12)、宮崎修治(6,11)、島津裕行(9)、石倉賢一(10)',
    performance   = '大沼心(1,2,7,12)、松澤建一(3)、上坪亮樹(4)、飯村正之(5)、宮崎修治(6,11)、高島大輔(8)、森義博(9)、北川正人(10)、石倉賢一(10)',
    music         = '天門・柳英一郎',
    chara_original = '七尾奈留、2C＝がろあ',
    chara_design  = '杉山延寛',
    series_composition = '高山カツヒコ',
    art_director  = '加藤恵',
    color_design  = '日比野仁',
    chief_animation_director = '杉山延寛',
    animation_director = '杉山延寛、潮月一也、古川英樹、田畑昭、中山初絵、伊藤良明、田中穣、清水慶太、宮崎修治、潮月一也、玉木慎吾、沼津雅人、西田美弥子',
    photography_director = '内村祥平',
    planning      = '川村明廣、酒井伸和、太布尚弘、及川武',
    alias         = '悠久之翼1、ef1',
...
UPDATE anime
SET storyboard    = '庵野秀明(1-2,7,10,14,20,23-26)、摩砂雪(1-2,6,11-12,19,24)、鶴巻和哉(3,16,20,22-23,25-26)、石堂宏之(3)、甚目喜一 [ 佐藤順一 ] (4-5,15,21)、杉山慶一(7)、樋口真嗣(8-9)、加賀剛(10)、岡村天斎(13,18)、小黒晃(17)、ビデオフォーマット版：摩砂雪(23)',
    ...
    art_director  = '加藤浩',
    color_design  = '高星晴美',
    animation_director = '鈴木俊二(1,5,7,15,23)、本田雄(2,8,19,25)、細井信宏(3,6)、重田智(4,10,12,21)、長谷川眞也(9,16)、河口俊夫(11)、黄瀬和哉(13,18)、花畑まう [ 湖川友謙 ] (17,22)、鶴巻和哉(20)、摩砂雪(24)、ビデオフォーマット版：鈴木俊二(21)、本田雄(22)、貞本義行(22)、鶴巻和哉(22)',
    photography_director = '黒田洋一',
    planning      = 'GAINAX / Project Eva.',
    alias         = 'EVA、Shin Seiki Evangerion',
...
UPDATE anime
SET storyboard    = '浜崎博嗣(1,14,17,23β,24)、佐藤卓哉(2,12-13,17,23β,24)、サトウシンジ(3)、おざわかずひろ(4,10,17,23,23β)、池田重隆(5,11,17)、村川健一郎 [ 川村賢一 ](6,16,21)、加藤敏幸(7,18)、若林漢二(8,14)、小林智樹(9,15,25)、須間雅人 [ 小林常夫 ](19,22)',
    ...
    chara_original = 'huke',
    chara_design  = '坂井久太',
    series_composition = '花田十輝',
    art_director  = '衛藤功二',
    color_design  = '佐藤美由紀',
    chief_animation_director = '坂井久太',
    animation_director = '坂井久太、中村和久、池上たろう、佐藤天昭、中田正彦、青野厚司、武本大介、稲吉智重、稲吉朝子、川田剛、いがりたかし、松原一之、吉井弘幸、新井伸浩、竹田逸子、山本善哉、泉保良輔',
    photography_director = '中村圭介',
    planning      = '安田猛、及川武',
    alias         = '石头门、斯坦因之门',
...
UPDATE anime
SET storyboard    = '水島努(1,24)、平井義通(2)、許琮(3,8,10,17,23-24)、岡村正弘(4)、湖山禎崇(5,9)、かおり(6)、菅沼芙実彦(7,13,15,23)、柿本広大(11)、倉川英揚(12,16,22)、駒井一也(14)、高村彰(18)、篠原俊哉(19)、成田歳法(20)、畑博之(21)',
    ...
    chara_original = 'ぽんかん⑧',
    chara_design  = '関口可奈味',
    series_composition = '横手美智子',
    art_director  = '竹田悠介、垣堺司',
    color_design  = '井上佳津枝',
    chief_animation_director = '関口可奈味',
    animation_director = '関口可奈味、秋山有希、大東百合恵、川面恒介、朱絃沰(주현우)、熊田明子、西畑あゆみ、森島範子、朴允玉(박윤옥)、神崎舞人、川口千里、鈴木理沙、川村夏生、竹田欣弘、齊藤佳子、しまだひであき、松坂定俊、野田康行、佐藤陽子、今泉賢一、酒井智史、宮川智恵子、渡辺佳奈子、佐野陽子、深澤謙二、武田牧子、容洪、徐正徳(서정덕)',
    photography_director = '梶原幸代',
    planning      = '川村明廣、堀川憲司、臼井久人、武智恒雄、難波秀行、太布尚弘、安田猛、立本洋之',
    alias         = 'Shirobako',
    quote         = '动画的当下，就在这里。',
...
UPDATE anime
SET performance   = '大沼心(1,2,7,12)、松澤建一(3)、上坪亮樹(4)、飯村正之(5)、宮崎修治(6,11)、高島大輔(8)、森義博(9)、北川正人(10)、石倉賢一(10)',
...
UPDATE anime
SET storyboard    = '三浦貴博(0,3,10)、野中卓也(1,4,8)、笹嶋啓一(2)、白井俊行(5,12)、高橋タクロヲ(6,12)、栖原隆史(7,11)、宇田明彦(9)、高橋健二(11)、高橋健司',
    performance   = '三浦貴博(0)、野中卓也(1,4,8)、栖原隆史(2,7,ED)、恒松圭(3)、白井俊行(5,12)、高橋健二(5)、高橋タクロヲ(6,12)、宇田明彦(9)、丸山裕介(10-11)',
    music         = '深澤秀行',
    chara_original = '武内崇',
    chara_design  = '須藤友徳、田畑壽之、碇谷敦',
    series_composition = 'ufotable',
    art_director  = '衛藤功二',
    color_design  = '千葉絵美、松岡美佳',
    chief_animation_director = '須藤友徳、田畑壽之、碇谷敦',
    animation_director = '須藤友徳、田畑壽之、佐藤哲人、茂木貴之、石塚みゆき、青木拓也、藤崎静香、碇谷敦、白井俊行、加藤やすひさ、菊池隼也、緒方美枝子、小船井充、清水慶太、辻雅俊',
    photography_director = '寺尾優一',
    alias         = '命运之夜 无限剑制、Fate/stay night UBW',
    quote         = '此为，贯彻信念的故事。',
...
UPDATE anime
SET storyboard    = '安藤真裕、安斎剛文、篠原俊哉、橋本昌和、橘正紀、許琮、岡村天斎、西村純二、入江泰浩',
    performance   = 'かおり、倉川英揚、太田知章、安藤真裕、橋本昌和、篠原俊哉、西村純二、柿本広大、羽生尚靖、安斎剛文、守岡博、許琮',
    music         = '浜口史郎',
    chara_original = '岸田メル',
    chara_design  = '関口可奈味',
    series_composition = '岡田麿里',
    art_director  = '東地和生；辅佐：平柳悟',
    color_design  = '井上佳津枝',
    chief_animation_director = '関口可奈味',
    animation_director = '落合瞳、江森真理子、川面恒介、吉田優子、山内尚樹、鈴木美咲、伊藤依織子、三嶽理絵、小島明日香、福永純一、鍋田香代子、小川エリ、홍석표、丸山宏一、田中春香、肥塚正史、石井百合子、関口可奈味、大塚あきら、川口千里、天﨑まなむ、許宰銑、岡村正弘、大導寺美穂',
    photography_director = '並木智',
    planning      = '角田博昭、沼生祐介、板橋秀徳、田口浩司、倉重宣之、木村康貴、米倉功人',
    alias         = '花开物语、Hanasaku Iroha',
    quote         = '花咲くいつか、某天会绽放的花朵',
...
UPDATE anime
SET storyboard    = '新房昭之(NC)、芦野芳晴(1,2,3)、笹木信作(4,6,10,12)、小俣真一(5,8)、西田正義(7)、七嶋典子(9)、伊藤智彦(11)',
    performance   = '宮本幸裕(1,12)、向井雅浩(2,9)、八瀬祐樹(3,10)、小俣真一(4)、間島崇寛(5)、浅利藤彰(6)、城所聖明(7)、川畑喬(8)、渡邉こと乃(11)',
    music         = '梶浦由記',
    chara_original = '蒼樹うめ',
    chara_design  = '岸田隆宏',
    series_composition = '虚淵玄(Nitro+)',
    art_director  = '稲葉邦彦・金子雄司(1-6)、内藤健(7-12)',
    color_design  = '日比野仁・滝沢いづみ',
    chief_animation_director = '谷口淳一郎、高橋美香',
    animation_director = '江畑諒真、高橋美香、実原登、鳥山冬美、潮月一也、神谷智大、小関雅、本多美乃、松本麻友子、小菅和久、宮嶋仁志、福永純一、小林亮、門智昭、近藤優次、松本朋之、片山みゆき、牧孝雄、松本元気、岩崎安利、伊藤良明、半澤淳、関口雅浩、宮前真一、藤澤俊幸、谷口淳一郎',
    photography_director = '江藤慎一郎',
    planning      = '夏目公一朗、孝壽尚志、峯岸卓生、小坂崇氣、太布尚弘、久保田光俊、竹田靑滋',
    alias         = 'Mahou Shoujo Madoka Magica、魔法少女小圆☆魔力',
    quote         = '和我签订契约，成为魔法少女吧！',
