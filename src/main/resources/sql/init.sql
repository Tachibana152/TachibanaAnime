...
INSERT INTO anime (id, title, title_jp, category, cover, original, director, writer, episodes, air_date, air_weekday, production, synopsis, content, view_count, sort, create_time)
VALUES (1, '葬送的芙莉莲Ⅱ', '葬送のフリーレン 第2期', 'NEW', '/uploads/anime/Frieren2nd.jpg', '山田鐘人・アベツカサ（小学館）', '北川朋哉', '鈴木智尋', 12, '2026年1月16日', '星期五', 'MADHOUSE',
...
第二季继续讲述芙莉莲在旅途中的邂逅与告别，以及那跨越时间的情感与魔法。',
       ...
       (2, '中国奇谭 第二季', '中国奇谭 第二季', 'NEW', '/uploads/anime/chinese_ancient.jpg', '上海美术电影制片厂', '陈莲华、胡睿等12位导演', '', 9, '2026年1月1日', '星期四', '上海美术电影制片厂、上影元、bilibili',
...
作品汇集12位导演，创作9部风格迥异的短片。第二部的故事将走入烟火人间，在延续"用中国方式讲中国故事"的基础上，更侧重对人的自我身份、家庭关系、社会关系的思考和探讨。',
       ...
       (3, '炎炎消防队Ⅲ', '炎炎ノ消防隊 参ノ章', 'NEW', '/uploads/anime/Enen_no_Shouboutai3rd.jpg', '大久保篤', '南川達馬', '', 12, '2026年1月9日', '星期五', 'david production',
       ...
       (4, 'Fate/strangeFake', 'フェイト／ストレンジフェイク', 'NEW', '/uploads/anime/Fate_strange_Fake.jpg', '奈須蘑菇（原作：成田良悟）', '榎戸骏', '', 12, '2026年1月3日', '星期六', 'A-1 Pictures',
       ...
       (5, '咒术回战Ⅲ', '呪術廻戦 第3期', 'NEW', '/uploads/anime/Jujutsu_Kaisen3rd.jpg', '芥見下々', '朴性厚', '', 12, '2026年1月14日', '星期三', 'MAPPA',
        '以诅咒为食的咒术师与咒灵之间的战斗持续升级。虎杖悠仁与伙伴们在涩谷事变之后，迎来了更加残酷的展开。',
        '咒术师与咒灵之间暗流涌动，虎杖、伏黑、钉崎等人的命运在巨大的恶意面前不断被推向极限。',
        3120, 6, '2026-01-01 00:00:00'),
       (6, '少女与战车 lovelove大作战 第2幕', 'ガールズ&パンツァー もっとらぶらぶ作戦です! 第2幕', 'NEW', '/uploads/anime/lovelove.jpg', '「ガールズ＆パンツァー」シリーズ', '下田正美', '木村暢', 1, '2026年1月30日', '星期五', 'P.A.WORKS×アクタス',
       ...
       (7, '机动战士高达 剧场版', '機動戦士ガンダム 閃光のハサウェイ', 'NEW', '/uploads/anime/MOBILE_SUIT_GUNDAM_HATHAWAY_The_Sorcery_of_Nymph_Circe.jpg', '富野由悠季', '村濑修功', '', 1, '2026年1月30日', '星期五', 'サンライズ',
        '剧场版动画，讲述哈萨维·诺亚继承父亲意志，以"马夫蒂"之名向地球联邦发起革命的战斗物语。',
        '宇宙世纪的反抗之焰在星光中燃烧，哈萨维的决断将改写世界的未来。',
        1277, 4, '2026-01-01 00:00:00'),
       (8, '我推的孩子Ⅲ', '【推しの子】第3期', 'NEW', '/uploads/anime/oshi_no_ko3rd.jpg', '赤坂アカ、横枪メンゴ', '平牧大輔', '', 12, '2026年1月14日', '星期三', '動画工房',
        '演艺圈与偶像的光与影。星野爱之子的复仇与成长物语，第三期将走向更加炽热的舞台。',
        '阿奎亚与露比各自追逐着目标，在闪耀的聚光灯下，隐藏的真相逐渐浮出水面。',
        2680, 3, '2026-01-01 00:00:00'),
       (11, 'CLANNAD', 'CLANNAD -クラナド-', 'CLASSIC', '/uploads/anime/CLANNAD.jpg', 'Key/VISUAL ARTS', '石原立也', '志茂文彦', 23, '2007年10月4日', '星期四', '京都アニメーション',
...
更多精彩内容请前往动画主页查看。',
       ...
       (12, '悠久之翼 ~前篇~', 'ef - a tale of memories.', 'CLASSIC', '/uploads/anime/ef-the-latter-tale.jpg', 'minori・鏡遊・御影', '大沼心', '高山カツヒコ', 12, '2007年10月6日', '星期六', 'SHAFT',
       ...
       (13, '新世纪福音战士 EVA', '新世紀エヴァンゲリオン', 'CLASSIC', '/uploads/anime/EVA.jpg', 'GAINAX → 庵野秀明', '庵野秀明', '庵野秀明、榎戸洋司等', 26, '1995年10月4日', '星期三', 'タツノコプロ、GAINAX',
       ...
       (14, '命运石之门', 'STEINS;GATE', 'CLASSIC', '/uploads/anime/STEINS_GATE.jpg', '5pb./Nitroplus', '佐藤卓哉、浜崎博嗣', '花田十輝', 25, '2011年4月6日', '星期三', 'WHITE FOX',
       ...
       (15, '白箱 SHIROBAKO', 'SHIROBAKO', 'CLASSIC', '/uploads/anime/SHIROBAKO.jpg', '原创动画', '水岛努', '横手美智子', 24, '2014年10月9日', '星期四', 'P.A.WORKS',
       ...
       (16, '猫和老鼠', 'Tom and Jerry', 'CLASSIC', '/uploads/anime/Tom_and_Jerry.jpg', 'William Hanna, Joseph Barbera', 'William Hanna', '', 161, '1940年2月10日', '', 'Warner Bros.',
        '汤姆与杰瑞这对欢喜冤家的无休止追逐，跨越了半个多世纪的经典喜剧动画，陪伴了无数人的童年。',
        '1940年首播，多次获得奥斯卡最佳动画短片奖，以夸张的肢体喜剧与精妙的配乐闻名于世。',
        12345, 15, '2026-01-01 00:00:00'),
       (17, 'Fate/Stay Night', 'フェイト/ステイナイト', 'CLASSIC', '/uploads/anime/Fate_15th.webp', '奈須蘑菇、TYPE-MOON', '山口祐司', '', 24, '2006年1月6日', '星期五', 'Studio Deen',
       ...
       (18, '花开伊吕波', '花咲くいろは', 'CLASSIC', '/uploads/anime/Hanasaku_Iroha.jpg', 'P.A.WORKS', '安藤真裕', '', 26, '2011年4月3日', '星期日', 'P.A.WORKS',
       ...
       (19, '魔法少女小圆', '魔法少女まどか☆マギカ', 'CLASSIC', '/uploads/anime/R-C.jpg', 'Magica Quartet', '新房昭之', '虚渊玄', 12, '2011年1月7日', '星期五', 'SHAFT',
